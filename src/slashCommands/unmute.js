...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const response = await member.timeout(0 * 60 * 1000, reason)
      ...
      .setColor("GREEN")
      .setDescription(`${client.emoji.success} | ${member} has been unmuted.`)
    ...
    if(member) {
      ...
      .setDescription(`${client.emoji.fail} | I cannot unmute that member. Make sure that my role is above their role or that I have sufficient perms to execute the command, OR they aren't muted.`)
      .setTimestamp()
