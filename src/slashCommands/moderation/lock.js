...
module.exports = {
  ...
  .addStringOption((option) => option.setName("reason").setDescription("The reason to lock the channel")),
  async execute(interaction) {
    ...
    channel.permissionOverwrites.edit(interaction.guild.id, { SEND_MESSAGES: false }).catch(() => {});
