...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (
      logging &&
      logging.moderation.warn_action && logging.moderation.waran_action !== "1"
      ) {
    ...
    if(mentionedMember) {
      ...
      .setColor(client.color.red)
      .setDescription(`${client.emoji.fail} | I can't warn that member. Make sure that my role is above their role or that I have sufficient permissions to execute the command.`)
      .setTimestamp()
