...
module.exports = {
  ...
  .addUserOption((option) => option.setName("member").setDescription("The member to remove the role from").setRequired(true))
  ...
  async execute(interaction) {
    ...
    if (!role) {
      ...
      .setDescription(`${fail} | The user doesn't have that role!`)
      .setTimestamp()
      .setFooter({ text: "https://mee8.ml/" })
      .setColor(interaction.guild.me.displayHexColor)
      ...
      try {
        ...
        interaction.reply({
          embeds: [
            ...
            .setDescription(`${fail} | Unable to remove the role from the user.`)
            .setTimestamp()
            .setFooter({ text: "https://mee8.ml/" })
            .setColor(interaction.guild.me.displayHexColor),
          ],
