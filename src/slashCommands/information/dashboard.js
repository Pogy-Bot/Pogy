...
<<<<<<< HEAD
    .setName("dashboard")
    .setDescription(
      "Need help getting to the dashboard of MEE8? Use this command!",
    ),
  async execute(interaction) {
    const dashembed = new MessageEmbed()
      .setTitle("Need MEE8's dashboard link?")
      .setDescription(
        "Click [here](https://g5qzg2-5003.csb.app) to see MEE8's dashboard",
      )
      .setColor("RANDOM")
...
=======
  ...
  async execute(interaction) {
    ...
    .setTimestamp();
>>>>>>> 7d8b702556adf9ef05497e482e718f8303419851
